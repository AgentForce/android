...
public class BottomNavigationFixedItemView extends BottomNavigationItemViewAbstract {
    ...
    //test
    private boolean isMaintainAlpha;
    ...
    public BottomNavigationFixedItemView(final BottomNavigation parent, boolean expanded, final MenuParser.Menu menu) {
        ...
        //test
        this.isMaintainAlpha = menu.isMaintainAlpha();
    ...
    private void updateLayoutOnAnimation(final float fraction, final boolean expanded) {
        ...
        if(isMaintainAlpha) {
            dstColor = enabled ? (expanded ? colorActive : colorActive) : colorDisabled;
            srcColor = enabled ? (expanded ? colorActive : colorActive) : colorDisabled;
        }else
        {
            dstColor = enabled ? (expanded ? colorActive : colorInactive) : colorDisabled;
            srcColor = enabled ? (expanded ? colorInactive : colorActive) : colorDisabled;
        }
