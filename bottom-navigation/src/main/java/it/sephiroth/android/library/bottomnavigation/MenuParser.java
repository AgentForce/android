...
class MenuParser {
    ...
    static class Menu {
        ...
        public void setItems(final BottomNavigationItem[] items) {
            ...
            this.shifting = (null != items && items.length > 1 && !forceFixed);
        }
        ...
        //test
        public boolean isMaintainAlpha()
        {
            return maintainAlpha;
        }
    ...
    private void readMenu(final Context context, final AttributeSet attrs) {
        ...
        //test
        menu.maintainAlpha = a.getBoolean(R.styleable.BottomNavigationMenu_bbn_maintainAlpha, false);
        a.recycle();
    }
