...
import manulife.manulifesop.activity.FAGroup.contact.ContactPersonPresenter;
import manulife.manulifesop.activity.FAGroup.contact.updateContactInfo.UpdateContactInfoActivity;
import manulife.manulifesop.activity.FAGroup.contact.updateContactInfo.UpdateContactInfoContract;
...
public class AddContactPersonActivity extends BaseActivity<AddContactPersonPresenter> implements AddContactPersonContract.View {
    ...
    private void loadDateList() {
        ...
        for (int i = 0; i < 10; i++) {
            mDataAll.add(new ContactPerson(false, "avartar", "name " + i, "phone " + i, 0));
        }
        for (int i = 0; i < 10; i++) {
            mDataAll.add(new ContactPerson(false, "avartar", "mame " + i, "phone " + i, 1));
        }
        if (adapter == null) {
