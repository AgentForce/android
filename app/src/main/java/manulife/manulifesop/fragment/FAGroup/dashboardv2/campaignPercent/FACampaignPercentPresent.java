...
public class FACampaignPercentPresent extends BasePresenter<FACampaignPercentContract.View> implements FACampaignPercentContract.Action{
    Context mContext;
    public FACampaignPercentPresent(FACampaignPercentContract.View presenterView,Context context) {
        super(presenterView);
