...
public class COPTabPresent extends BasePresenter<COPTabContract.View> implements COPTabContract.Action{

    private Context mContext;
    //private int mStatus;

    public COPTabPresent(COPTabContract.View presenterView, Context context) {
        super(presenterView);
