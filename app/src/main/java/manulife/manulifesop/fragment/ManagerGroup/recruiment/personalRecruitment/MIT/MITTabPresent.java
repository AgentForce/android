...
public class MITTabPresent extends BasePresenter<MITTabContract.View> implements MITTabContract.Action{

    private Context mContext;

    public MITTabPresent(MITTabContract.View presenterView, Context context) {
        super(presenterView);
