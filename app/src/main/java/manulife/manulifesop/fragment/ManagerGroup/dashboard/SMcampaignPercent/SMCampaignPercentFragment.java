...
public class SMCampaignPercentFragment extends BaseFragment<MainFAActivity, SMCampaignPercentPresent> implements SMCampaignPercentContract.View {

    @BindView(R.id.circular_progress_step1)
    CircularProgressBar circularProgressBar1;
    @BindView(R.id.circular_progress_step2)
    CircularProgressBar circularProgressBar2;
    @BindView(R.id.circular_progress_step3)
    CircularProgressBar circularProgressBar3;
    @BindView(R.id.circular_progress_step4)
    CircularProgressBar circularProgressBar4;
    @BindView(R.id.circular_progress_step5)
    ...
    public static SMCampaignPercentFragment newInstance(List<Integer> percents, List<Integer> percentForcast, String type, int month, DashboardSMResult dataWeekMonth) {
        ...
        SMCampaignPercentFragment fragment = new SMCampaignPercentFragment();
    ...
    public int contentViewLayout() {
        return R.layout.fragment_fa_campaignpercent;
    }

    @Override
    public void initializeLayout(View view) {
        mActionListener = new SMCampaignPercentPresent(this, getContext());
    }
    ...
    private void initViews() {
        ...
        circularProgressBar1.setSubTitle("Liên hệ");
        circularProgressBar1.setProgress(mPercents.get(0));
        circularProgressBar1.setProgressColor(getCorlorProgress(mPercents.get(0)));

        circularProgressBar2.setTitle(mPercents.get(1) + "%");
        circularProgressBar2.setSubTitle("Hẹn gặp");
        circularProgressBar2.setProgress(mPercents.get(1));
        circularProgressBar2.setProgressColor(getCorlorProgress(mPercents.get(1)));

        circularProgressBar3.setTitle(mPercents.get(2) + "%");
        circularProgressBar3.setSubTitle("Tư vấn");
        circularProgressBar3.setProgress(mPercents.get(2));
        circularProgressBar3.setProgressColor(getCorlorProgress(mPercents.get(2)));

        circularProgressBar4.setTitle(mPercents.get(3) + "%");
        circularProgressBar4.setSubTitle("Hợp đồng");
        circularProgressBar4.setProgress(mPercents.get(3));
        circularProgressBar4.setProgressColor(getCorlorProgress(mPercents.get(3)));

        circularProgressBar5.setTitle(mPercents.get(4) + "%");
        circularProgressBar5.setSubTitle("Giới thiệu");
        circularProgressBar5.setProgress(mPercents.get(4));
    ...
    public void updateData() {
        ((SMDashBoardFragment) this.getParentFragment()).updateData();
    }
    ...
    private void initAllViewsMonth(View view) {
        ((TextView) view.findViewById(R.id.txt_title)).setText(
                "Chỉnh sửa mục tiêu hợp đồng tháng " + Utils.getCurrentMonth(getContext())
        );
        ...
        txtMonthOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showConfirm("Xác nhận", "Đồng ý tăng số lượng hợp đồng?", "Đồng ý",
                        "Hủy", SweetAlertDialog.WARNING_TYPE, new CallBackConfirmDialog() {
                            @Override
                            public void DiaglogPositive() {
                                alertDialog.dismiss();
