...
public class ContactAllSMAdapter extends RecyclerView.Adapter<ContactAllSMAdapter.ViewHolder> {
    //Declares variables
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtProcessStep.setText(ProjectApplication.getInstance().getStringProcessStatusNameSM(
